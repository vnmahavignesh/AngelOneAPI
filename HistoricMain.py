...
if __name__ == "__main__":
    ...
    if session_data['status'] == 'success':
        ...
        if data_manager:
            ...
            # Print the output CSV path where the historical data has been saved
            print(f"\nHistorical candle data saved to: {output_csv}")
        else:
            # Print a failure message if the historical data manager instance could not be created
            print("\nFailed to fetch historic data")
    else:
        # Print a failure message if the login was not successful and historical data cannot be fetched
