...
Step 1: Create virtual Enviornment to run and include all your libraries 
python -m venv myenv (myenv is enviornment name can be any) 

Step 2: Activate the venv 
myenv\Scripts\activate (after activation you could see like this -> (myenv) PS F:\Generative AI\AngelOneAPI>)

Step 3: python -m pip install --upgrade pip

Step 4: pip install -r requirements.txt (To Install dependencies from this txt file)
